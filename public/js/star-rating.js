        ...
        e = function (c, e) {
            ...
            (this.element = c),
                ...
                e.starGradient ||
                    ...
                    (this.settings.starGradient.start =
                        this.settings.starGradient.end =
        ...
        f = {
            ...
            getIndex: function (b) {
                ...
                return (
                    ...
                    (g =
                        f && f <= this.settings.totalStars && f > g ? f - 1 : g)
                );
            },
            getOffsetByPixel: function (a, b, c) {
                var d = a.pageX - b.offset().left;
                return c / 2 >= d && !this.settings.useFullStars
                    ? "left"
                    : "right";
            },
            initRating: function () {
            ...
            paintStars: function (b, c) {
                ...
                a.each(
                    ...
                    function (i, j) {
                        ...
                        (k =
                            h.ratedColors &&
                            h.ratedColors.length &&
                            h.ratedColors[l]
                                ? h.ratedColors[l]
                                : this._defaults.ratedColor),
                            "rated" === c &&
                                b > -1 &&
                                ((i <= Math.ceil(b) || (1 > i && 0 > b)) &&
                                    d.attr("style", "fill:" + k),
